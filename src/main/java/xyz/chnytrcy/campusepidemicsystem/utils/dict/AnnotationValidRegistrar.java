...
public class AnnotationValidRegistrar {
  ...
  private final String BASE_ENUMS_PACKAGE = "xyz/chnytrcy/campusepidemicsystem/model/enums/entity/*class";

  private final String BASE_ERROR_PACKAGE = "xyz/chnytrcy/campusepidemicsystem/model/enums/*Error*";
