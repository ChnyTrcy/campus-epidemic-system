...
public enum StudentDailyEnums  implements BaseEnum {
  ...
  TEMPERATURE_ABNORMAL_NORMAL(0,"体温正常"),
  TEMPERATURE_ABNORMAL_ABNORMAL(1,"体温异常"),
  ABNORMAL_SYMPTOMS_NORMAL(0,"无异常症状"),
  ABNORMAL_SYMPTOMS_ABNORMAL(1,"有异常症状"),
  HEALTH_CODE_GREEN(0,"健康码-绿"),
  HEALTH_CODE_YELLOW(1,"健康码-黄"),
  HEALTH_CODE_RED(2,"健康码-红"),
  HEALTH_CODE_NULL(3,"健康码未上传"),
  PROMISE_YES(0,"承诺-接受"),
  PROMISE_NO(1,"承诺-拒绝")
