...
public enum FeedbackAcceptanceEnums implements BaseEnum {
  PRODUCER_TYPE_ISOLATION(1,"隔离人员"),
  PRODUCER_TYPE_EPIDEMIC_PREVENTION(2,"防疫人员"),
  TYPE_MATERIAL(1,"物资请求"),
  TYPE_OPINION(2,"意见申诉"),
  RESULT_UNREAD(0,"未读"),
  RESULT_AGREE(1,"同意"),
  RESULT_REJECT(2,"拒绝"),
  RESULT_NOT_HANDLER(3,"无法处理"),
  IS_END_YES(1,"已结束"),
  IS_END_NO(0,"未结束"),
  ADMIN_RELATED_TAG_YES(1,"与管理员相关"),
  ADMIN_RELATED_TAG_NO(0,"与管理员无关")
  ;
